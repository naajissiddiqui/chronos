...
/**
 * Kafka event consumed from the {@code execution.failed} topic.
 *
...
public class ExecutionFailedEvent {
    ...
    public ExecutionFailedEvent(UUID executionId, UUID jobId, UUID organizationId,
                                 String workerId, Integer attempt,
                                 Instant failedAt, String errorMessage) {
